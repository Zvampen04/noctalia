...
public:
  ...
  // Change a fixed-size panel's anchor, extent and margins in one Wayland commit.
  void requestPlacement(std::uint32_t anchor, std::uint32_t width, std::uint32_t height,
